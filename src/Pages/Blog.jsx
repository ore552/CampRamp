        ...
        <div className='services' id='blog'>
            ...
            <ul className='cards'>
                <li className='card'>
                    ...
                    <p>I just bought an RV on CampRamp and it was such a good price, I got it for £40 for the whole journey! <br /> I could have used for years and still only had to pay 40*! <br /> My lovely wife and lively children all had a great experince, <br /> and all the RVs and trailers are still the same price, no matter what condition(which is always pitch perfect) it's in. <br /> My one had a sofa bed which was soooo soft. Try it, you'll love it.</p>
                    <br />
                ...
                <li className='card'>
                    ...
                    <p>Going to Qatar is an experience, and with amazing camping gear? <br /> I didn't know that CampRamp was everywhere. <br /> Yep, it has been reported all around the world that CampRamp could import gear. <br /> In fact, there are shops around dotted around each country, and wow did it prevail! <br /> Now I could sun bathe in the sand and enjoy my honeymoon in Qatar!</p>
                    <img src="src/assets/desert-campin.jpg" alt="img" />
                </li>
                <li className='card'>
